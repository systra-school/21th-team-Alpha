  ...
  <body>
    <div id="wrapper">
      ...
      <%--Miku.Oosato ボタンカラー追加（cssファイルでは反映しないため）--%>
          ...
          <%--takaya onclick追加--%>
          <input value="基本シフト反映" type="button" class="lngButton" style="border:none; background-color:#FFD700;" onclick="submitShukkinKihon()" />
          <input value="出勤希望日反映" type="button" class="lngButton" style="border:none; background-color:#FFD700;" onclick="submitShukkinKibou()" />
          
        </div>
        <%--淵上　新たに登録用のdivクラスを作成し、marginを調整した --%>
        <div style="margin-left:1100px; margin-top:-40px;">
        <input value="登録" type="button"  class="smlButton" style="border:none; background-color:#ff80ff;" onclick="submitRegist()" />
        </div>
        <table>
          <tr>
            <td id="footLeft">
