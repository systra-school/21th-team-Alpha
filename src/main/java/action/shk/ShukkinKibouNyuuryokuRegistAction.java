...
public class ShukkinKibouNyuuryokuRegistAction extends ShukkinKibouAbstractAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest req,
		...
		// 画面のリスト情報
		List<TsukibetsuShiftNyuuryokuBean> tsukibetsuShiftBeanList = tsukibetsuShiftForm
				.getTsukibetsuShiftNyuuryokuBeanList();

		// Miku.Oosato 対象年月表示後、DB登録
		...
		// フォームデータをDtoに変換する
		List<List<TsukibetsuShiftDto>> tsukibetsuShiftDtoListList = this.formToDto(tsukibetsuShiftBeanList,
				dateBeanList);
